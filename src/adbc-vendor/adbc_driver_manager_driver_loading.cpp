...
AdbcStatusCode ManagedLibrary::GetDriverInfo(const std::string_view driver_name,
...
AdbcStatusCode ManagedLibrary::SearchPathsForDriver(const std::filesystem::path &driver_path,
...
AdbcStatusCode ManagedLibrary::FindDriver(const std::filesystem::path &driver_path,
                                          const AdbcLoadFlags load_options,
                                          const std::vector<std::filesystem::path> &additional_search_paths,
                                          DriverInfo &info,
                                          struct AdbcError *error) {
...
AdbcStatusCode ManagedLibrary::Lookup(const char *name, void **func, struct AdbcError *error) {
#if defined(_WIN32)
