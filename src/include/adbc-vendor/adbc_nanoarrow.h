...
#define _NANOARROW_CHECK_UPPER_LIMIT(x_, max_) NANOARROW_RETURN_NOT_OK((x_ <= max_) ? NANOARROW_OK : EINVAL)
...
#define NANOARROW_FLAG_ALL_SUPPORTED (ARROW_FLAG_DICTIONARY_ORDERED | ARROW_FLAG_NULLABLE | ARROW_FLAG_MAP_KEYS_SORTED)
...
#define NANOARROW_RETURN_NOT_OK(EXPR)                                                                                  \
    _NANOARROW_RETURN_NOT_OK_IMPL(_NANOARROW_MAKE_NAME(errno_status_, _NANOARROW_UNIQUE_SUFFIX), EXPR)
...
#define NANOARROW_RETURN_NOT_OK_WITH_ERROR(EXPR, ERROR_EXPR)                                                           \
    _NANOARROW_RETURN_NOT_OK_WITH_ERROR_IMPL(_NANOARROW_MAKE_NAME(errno_status_, _NANOARROW_UNIQUE_SUFFIX),            \
                                             EXPR,                                                                     \
                                             ERROR_EXPR,                                                               \
                                             #EXPR)
...
#define NANOARROW_PRINT_AND_DIE(VALUE, EXPR_STR)                                                                       \
    do {                                                                                                               \
        fprintf(stderr, "%s failed with code %d\n* %s:%d\n", EXPR_STR, (int)(VALUE), __FILE__, (int)__LINE__);         \
        abort();                                                                                                       \
    } while (0)
#endif
...
#define NANOARROW_ASSERT_OK(EXPR)                                                                                      \
    _NANOARROW_ASSERT_OK_IMPL(_NANOARROW_MAKE_NAME(errno_status_, _NANOARROW_UNIQUE_SUFFIX), EXPR, #EXPR)
...
static inline ArrowErrorCode ArrowArrayStreamGetSchema(struct ArrowArrayStream *array_stream,
...
static inline ArrowErrorCode ArrowArrayStreamGetNext(struct ArrowArrayStream *array_stream,
...
typedef void (*ArrowBufferDeallocatorCallback)(struct ArrowBufferAllocator *allocator, uint8_t *ptr, int64_t size);
...
#define ArrowNanoarrowVersionInt NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowNanoarrowVersionInt)
...
#define ArrowBufferAllocatorDefault NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowBufferAllocatorDefault)
#define ArrowBufferDeallocator NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowBufferDeallocator)
...
#define ArrowDecimalAppendDigitsToBuffer NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowDecimalAppendDigitsToBuffer)
#define ArrowDecimalAppendStringToBuffer NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowDecimalAppendStringToBuffer)
...
#define ArrowSchemaSetTypeStruct NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeStruct)
#define ArrowSchemaSetTypeFixedSize NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeFixedSize)
#define ArrowSchemaSetTypeDecimal NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeDecimal)
#define ArrowSchemaSetTypeRunEndEncoded NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeRunEndEncoded)
#define ArrowSchemaSetTypeDateTime NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeDateTime)
#define ArrowSchemaSetTypeUnion NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetTypeUnion)
...
#define ArrowSchemaSetMetadata NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaSetMetadata)
#define ArrowSchemaAllocateChildren NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaAllocateChildren)
#define ArrowSchemaAllocateDictionary NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowSchemaAllocateDictionary)
#define ArrowMetadataReaderInit NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataReaderInit)
#define ArrowMetadataReaderRead NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataReaderRead)
...
#define ArrowMetadataBuilderInit NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataBuilderInit)
#define ArrowMetadataBuilderAppend NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataBuilderAppend)
#define ArrowMetadataBuilderSet NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataBuilderSet)
#define ArrowMetadataBuilderRemove NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowMetadataBuilderRemove)
...
#define ArrowArrayInitFromType NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayInitFromType)
#define ArrowArrayInitFromSchema NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayInitFromSchema)
#define ArrowArrayInitFromArrayView NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayInitFromArrayView)
#define ArrowArrayInitFromArrayView NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayInitFromArrayView)
#define ArrowArrayAllocateChildren NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayAllocateChildren)
#define ArrowArrayAllocateDictionary NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayAllocateDictionary)
#define ArrowArraySetValidityBitmap NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArraySetValidityBitmap)
...
#define ArrowArrayFinishBuilding NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayFinishBuilding)
#define ArrowArrayFinishBuildingDefault NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayFinishBuildingDefault)
#define ArrowArrayViewInitFromType NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewInitFromType)
#define ArrowArrayViewInitFromSchema NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewInitFromSchema)
#define ArrowArrayViewAllocateChildren NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewAllocateChildren)
#define ArrowArrayViewAllocateDictionary NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewAllocateDictionary)
#define ArrowArrayViewSetLength NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewSetLength)
#define ArrowArrayViewSetArray NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewSetArray)
#define ArrowArrayViewSetArrayMinimal NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewSetArrayMinimal)
#define ArrowArrayViewValidate NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowArrayViewValidate)
...
#define ArrowBasicArrayStreamInit NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowBasicArrayStreamInit)
#define ArrowBasicArrayStreamSetArray NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowBasicArrayStreamSetArray)
#define ArrowBasicArrayStreamValidate NANOARROW_SYMBOL(NANOARROW_NAMESPACE, ArrowBasicArrayStreamValidate)
...
NANOARROW_DLL ArrowErrorCode ArrowDecimalAppendDigitsToBuffer(const struct ArrowDecimal *decimal,
                                                              struct ArrowBuffer *buffer);

/// \brief Get the decimal value of an ArrowDecimal as a string
NANOARROW_DLL ArrowErrorCode ArrowDecimalAppendStringToBuffer(const struct ArrowDecimal *decimal,
                                                              struct ArrowBuffer *buffer);
...
/// Caller is responsible for calling the array->release callback if
/// NANOARROW_OK is returned.
NANOARROW_DLL ArrowErrorCode ArrowArrayInitFromArrayView(struct ArrowArray *array,
...
///
/// array must have been allocated using ArrowArrayInitFromType()
static inline ArrowErrorCode ArrowArrayAddVariadicBuffers(struct ArrowArray *array, int32_t n_buffers);
...
/// corruptible source.
NANOARROW_DLL ArrowErrorCode ArrowArrayFinishBuilding(struct ArrowArray *array,
...
NANOARROW_DLL ArrowErrorCode ArrowArrayViewInitFromSchema(struct ArrowArrayView *array_view,
                                                          const struct ArrowSchema *schema,
                                                          struct ArrowError *error);
...
NANOARROW_DLL ArrowErrorCode ArrowArrayViewSetArrayMinimal(struct ArrowArrayView *array_view,
                                                           const struct ArrowArray *array,
                                                           struct ArrowError *error);
...
/// at each level.
NANOARROW_DLL ArrowErrorCode ArrowArrayViewValidate(struct ArrowArrayView *array_view,
                                                    enum ArrowValidationLevel validation_level,
                                                    struct ArrowError *error);
...
NANOARROW_DLL ArrowErrorCode ArrowBasicArrayStreamInit(struct ArrowArrayStream *array_stream,
...
NANOARROW_DLL ArrowErrorCode ArrowBasicArrayStreamValidate(const struct ArrowArrayStream *array_stream,
                                                           struct ArrowError *error);
...
static inline int64_t ArrowResolveChunk32(int32_t index, const int32_t *offsets, int32_t lo, int32_t hi) {
    // Similar to std::upper_bound(), but slightly different as our offsets
    // array always starts with 0.
    int32_t n = hi - lo;
    // First iteration does not need to check for n > 1
...
static inline ArrowErrorCode ArrowBufferSetAllocator(struct ArrowBuffer *buffer,
                                                     struct ArrowBufferAllocator allocator) {
...
static inline void ArrowBufferReset(struct ArrowBuffer *buffer) {
    buffer->allocator.free(&buffer->allocator, (uint8_t *)buffer->data, buffer->capacity_bytes);
...
static inline ArrowErrorCode ArrowBufferResize(struct ArrowBuffer *buffer, int64_t new_size_bytes, char shrink_to_fit) {
    ...
    int needs_reallocation =
        new_size_bytes > buffer->capacity_bytes || (shrink_to_fit && new_size_bytes < buffer->capacity_bytes);

    if (needs_reallocation) {
        buffer->data =
            buffer->allocator.reallocate(&buffer->allocator, buffer->data, buffer->capacity_bytes, new_size_bytes);
...
static inline ArrowErrorCode ArrowBufferReserve(struct ArrowBuffer *buffer, int64_t additional_size_bytes) {
    ...
    int64_t new_capacity_bytes = _ArrowGrowByFactor(buffer->capacity_bytes, min_capacity_bytes);
    buffer->data =
        buffer->allocator.reallocate(&buffer->allocator, buffer->data, buffer->capacity_bytes, new_capacity_bytes);
...
static inline void _ArrowBitmapPackInt8(const int8_t *values, uint8_t *out) {
    *out = (uint8_t)(values[0] | ((values[1] + 0x1) & 0x2) | ((values[2] + 0x3) & 0x4) | ((values[3] + 0x7) & 0x8) |
                     ((values[4] + 0xf) & 0x10) | ((values[5] + 0x1f) & 0x20) | ((values[6] + 0x3f) & 0x40) |
                     ((values[7] + 0x7f) & 0x80));
}
...
static inline void ArrowBitSetTo(uint8_t *bits, int64_t i, uint8_t bit_is_set) {
    bits[i / 8] ^= (uint8_t)(((uint8_t)(-((uint8_t)(bit_is_set != 0)) ^ bits[i / 8])) & _ArrowkBitmask[i % 8]);
}
...
static inline void ArrowBitsSetTo(uint8_t *bits, int64_t start_offset, int64_t length, uint8_t bits_are_set) {
    ...
    if (bytes_end == bytes_begin + 1) {
        ...
        const uint8_t only_byte_mask = i_end % 8 == 0 ? first_byte_mask : (uint8_t)(first_byte_mask | last_byte_mask);
...
static inline int64_t ArrowBitCountSet(const uint8_t *bits, int64_t start_offset, int64_t length) {
    if (length == 0) {
        return 0;
    }
    ...
    if (bytes_begin == bytes_last_valid) {
        ...
        const uint8_t only_byte_mask = i_end % 8 == 0 ? last_byte_mask : (uint8_t)(first_byte_mask & last_byte_mask);
...
static inline ArrowErrorCode ArrowBitmapResize(struct ArrowBitmap *bitmap, int64_t new_size_bits, char shrink_to_fit) {
    ...
    NANOARROW_RETURN_NOT_OK(ArrowBufferResize(&bitmap->buffer, new_size_bytes, shrink_to_fit));
...
// is made.
static inline int8_t _ArrowArrayUnionChildIndex(struct ArrowArray *array, int8_t type_id) {
    NANOARROW_UNUSED(array);
    return type_id;
}

static inline int8_t _ArrowArrayUnionTypeId(struct ArrowArray *array, int8_t child_index) {
    NANOARROW_UNUSED(array);
    return child_index;
}
...
static inline int8_t _ArrowUnionTypeIdsWillEqualChildIndices(const char *type_id_str, int64_t n_children) {
    int8_t type_ids[128];
...
static inline ArrowErrorCode _ArrowArrayAppendBits(struct ArrowArray *array,
    ...
    int64_t bytes_required =
        _ArrowRoundUpToMultipleOf8(private_data->layout.element_size_bits[buffer_i] * (array->length + 1)) / 8;
    if (bytes_required > buffer->size_bytes) {
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendFill(buffer, 0, bytes_required - buffer->size_bytes));
    }
...
static inline ArrowErrorCode _ArrowArrayAppendEmptyInternal(struct ArrowArray *array, int64_t n, uint8_t is_valid) {
    struct ArrowArrayPrivateData *private_data = (struct ArrowArrayPrivateData *)array->private_data;
    ...
    case NANOARROW_TYPE_DENSE_UNION: {
        ...
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendFill(ArrowArrayBuffer(array, 0), type_id, n));
        for (int64_t i = 0; i < n; i++) {
            NANOARROW_RETURN_NOT_OK(
                ArrowBufferAppendInt32(ArrowArrayBuffer(array, 1), (int32_t)array->children[0]->length - 1));
        }
    ...
    case NANOARROW_TYPE_FIXED_SIZE_LIST:
        NANOARROW_RETURN_NOT_OK(
            ArrowArrayAppendEmpty(array->children[0], n * private_data->layout.child_size_elements));
        break;
    case NANOARROW_TYPE_STRUCT:
        for (int64_t i = 0; i < array->n_children; i++) {
            NANOARROW_RETURN_NOT_OK(ArrowArrayAppendEmpty(array->children[i], n));
    ...
    for (int i = 0; i < NANOARROW_MAX_FIXED_BUFFERS; i++) {
        ...
        case NANOARROW_BUFFER_TYPE_DATA_OFFSET:
            ...
            for (int64_t j = 0; j < n; j++) {
                ArrowBufferAppendUnsafe(buffer, buffer->data + size_bytes * (array->length + j), size_bytes);
            }
...
static inline ArrowErrorCode ArrowArrayAddVariadicBuffers(struct ArrowArray *array, int32_t n_buffers) {
    ...
    private_data->variadic_buffers =
        (struct ArrowBuffer *)ArrowRealloc(private_data->variadic_buffers,
                                           sizeof(struct ArrowBuffer) * nvariadic_bufs_needed);
    ...
    private_data->buffer_data =
        (const void **)ArrowRealloc(private_data->buffer_data, array->n_buffers * sizeof(void *));
    ...
    private_data->buffer_data[NANOARROW_BINARY_VIEW_FIXED_BUFFERS + nvariadic_bufs_needed] = NULL;
...
static inline ArrowErrorCode ArrowArrayAppendBytes(struct ArrowArray *array, struct ArrowBufferView value) {
    ...
    if (private_data->storage_type == NANOARROW_TYPE_STRING_VIEW ||
        ...
        if (value.size_bytes <= NANOARROW_BINARY_VIEW_INLINE_SIZE) {
            ...
            memset(bvt.inlined.data + bvt.inlined.size, 0, NANOARROW_BINARY_VIEW_INLINE_SIZE - bvt.inlined.size);
        } else {
            int32_t current_n_vbufs = ArrowArrayVariadicBufferCount(array);
            if (current_n_vbufs == 0 ||
                private_data->variadic_buffers[current_n_vbufs - 1].size_bytes + value.size_bytes >
                    NANOARROW_BINARY_VIEW_BLOCK_SIZE) {
                const int32_t additional_bufs_needed = 1;
                NANOARROW_RETURN_NOT_OK(ArrowArrayAddVariadicBuffers(array, additional_bufs_needed));
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(variadic_buf, value.data.as_char, value.size_bytes));
        }
        ...
        struct ArrowBuffer *data_buffer =
            ArrowArrayBuffer(array, 1 + (private_data->storage_type != NANOARROW_TYPE_FIXED_SIZE_BINARY));
        int32_t offset;
        ...
        case NANOARROW_TYPE_BINARY:
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(data_buffer, value.data.data, value.size_bytes));
            break;
        ...
        case NANOARROW_TYPE_LARGE_BINARY:
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(offset_buffer, &large_offset, sizeof(int64_t)));
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(data_buffer, value.data.data, value.size_bytes));
            break;
...
static inline ArrowErrorCode ArrowArrayAppendDecimal(struct ArrowArray *array, const struct ArrowDecimal *value) {
    ...
    case NANOARROW_TYPE_DECIMAL64:
        if (value->n_words != 1) {
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(data_buffer, value->words, sizeof(uint64_t)));
            break;
        }
    case NANOARROW_TYPE_DECIMAL128:
        if (value->n_words != 2) {
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(data_buffer, value->words, 2 * sizeof(uint64_t)));
            break;
        }
    case NANOARROW_TYPE_DECIMAL256:
        if (value->n_words != 4) {
            ...
            NANOARROW_RETURN_NOT_OK(ArrowBufferAppend(data_buffer, value->words, 4 * sizeof(uint64_t)));
            break;
        }
    default:
        return EINVAL;
...
static inline ArrowErrorCode ArrowArrayFinishElement(struct ArrowArray *array) {
    ...
    case NANOARROW_TYPE_MAP:
        ...
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt32(ArrowArrayBuffer(array, 1), (int32_t)child_length));
        break;
    case NANOARROW_TYPE_LARGE_LIST:
        child_length = array->children[0]->length;
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt64(ArrowArrayBuffer(array, 1), child_length));
        break;
    case NANOARROW_TYPE_FIXED_SIZE_LIST:
        child_length = array->children[0]->length;
    ...
    case NANOARROW_TYPE_LIST_VIEW: {
        ...
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt32(ArrowArrayBuffer(array, 1), last_valid_offset));
        NANOARROW_RETURN_NOT_OK(
            ArrowBufferAppendInt32(ArrowArrayBuffer(array, 2), (int32_t)child_length - last_valid_offset));
    ...
    case NANOARROW_TYPE_LARGE_LIST_VIEW: {
        ...
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt64(ArrowArrayBuffer(array, 1), last_valid_offset));
        NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt64(ArrowArrayBuffer(array, 2), child_length - last_valid_offset));
        private_data->list_view_offset = child_length;
        break;
    }
...
static inline ArrowErrorCode ArrowArrayFinishUnionElement(struct ArrowArray *array, int8_t type_id) {
    ...
    case NANOARROW_TYPE_DENSE_UNION:
        ...
        NANOARROW_RETURN_NOT_OK(
            ArrowBufferAppendInt32(ArrowArrayBuffer(array, 1), (int32_t)array->children[child_index]->length - 1));
        break;
    case NANOARROW_TYPE_SPARSE_UNION:
    ...
    NANOARROW_RETURN_NOT_OK(ArrowBufferAppendInt8(ArrowArrayBuffer(array, 0), (int8_t)type_id));
    array->length++;
    return NANOARROW_OK;
}
...
static inline struct ArrowBufferView ArrowArrayViewGetBufferView(struct ArrowArrayView *array_view, int64_t i) {
    ...
    case NANOARROW_TYPE_STRING_VIEW:
        if (i < NANOARROW_BINARY_VIEW_FIXED_BUFFERS) {
        ...
        } else if (i >= (array_view->n_variadic_buffers + NANOARROW_BINARY_VIEW_FIXED_BUFFERS)) {
            ...
            struct ArrowBufferView view;
            view.data.data = array_view->variadic_buffers[i - NANOARROW_BINARY_VIEW_FIXED_BUFFERS];
...
enum ArrowBufferType ArrowArrayViewGetBufferType(struct ArrowArrayView *array_view, int64_t i) {
    switch (array_view->storage_type) {
    case NANOARROW_TYPE_BINARY_VIEW:
    case NANOARROW_TYPE_STRING_VIEW:
        if (i < NANOARROW_BINARY_VIEW_FIXED_BUFFERS) {
...
static inline int64_t ArrowArrayViewListChildOffset(const struct ArrowArrayView *array_view, int64_t i) {
    switch (array_view->storage_type) {
    case NANOARROW_TYPE_LIST:
    case NANOARROW_TYPE_MAP:
    case NANOARROW_TYPE_LIST_VIEW:
...
static struct ArrowBufferView ArrowArrayViewGetBytesFromViewArrayUnsafe(const struct ArrowArrayView *array_view,
                                                                        int64_t i) {
...
static inline struct ArrowStringView ArrowArrayViewGetStringUnsafe(const struct ArrowArrayView *array_view, int64_t i) {
    ...
    case NANOARROW_TYPE_BINARY:
        ...
        view.size_bytes = (int64_t)offsets_view->data.as_int32[i + 1] - offsets_view->data.as_int32[i];
        break;
    case NANOARROW_TYPE_LARGE_STRING:
    case NANOARROW_TYPE_LARGE_BINARY:
    ...
    case NANOARROW_TYPE_STRING_VIEW:
    case NANOARROW_TYPE_BINARY_VIEW: {
        struct ArrowBufferView buf_view = ArrowArrayViewGetBytesFromViewArrayUnsafe(array_view, i);
...
static inline void ArrowArrayViewGetIntervalUnsafe(const struct ArrowArrayView *array_view,
                                                   int64_t i,
